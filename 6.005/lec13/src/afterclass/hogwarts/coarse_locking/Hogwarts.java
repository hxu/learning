...
public class Hogwarts implements Castle {
    // people in the books
    private Wizard harry =      new Wizard(this, "Harry Potter");
    private Wizard hermione =   new Wizard(this, "Hermione Granger");
    private Wizard ron =        new Wizard(this, "Ron Weasley");
    private Wizard dumbledore = new Wizard(this, "Albus Dumbledore");
    private Wizard snape =      new Wizard(this, "Severus Snape");
